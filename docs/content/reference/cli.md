...
```
cellphones <command> [arguments] [flags]
```

Run `cellphones <command> --help` for the full flag list on any command. This
...
per operation you declare in `cellphones/domain.go`.
