...
// HTTP behaviour is covered in cellphones_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "cellphones://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("cellphones", "about")
	if err != nil || got.String() != "cellphones://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want cellphones://page/about", got.String(), err)
	}
}
